...
ALLOWED_HOSTS = ['evening-everglades-93458.herokuapp.com', '127.0.0.1',]
...
INSTALLED_APPS = [
    ...
    # This object was created for us in /catalog/app.py
...
# STATICFILES_DIRS = (
#     BASE_DIR / 'folder_for_your_additional_staticfiles',
# )
...
# Heroku: Update datebase configuration from $DATABASE_URL.
